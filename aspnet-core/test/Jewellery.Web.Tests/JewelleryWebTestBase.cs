...
{
    public abstract class JewelleryWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static JewelleryWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(JewelleryWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<JewelleryDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<JewelleryDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<JewelleryDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<JewelleryDbContext, Task<T>> func)
        {
            T result;
